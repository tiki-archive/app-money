...
class MoneyHomeViewListTransaction extends StatelessWidget{
  ...
  const MoneyHomeViewListTransaction({Key? key, required this.transaction}) : super(key: key);
            ...
            Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start ,children: [
              Row(
                children: [
                  ...
                  Padding(padding: EdgeInsets.only(left: service.style.size(5))),
                  transaction.listedOn != null ?
                  Image.asset("res/images/double-check.png", package: "money") :
                  transaction.backedUp != null ?
                  Image.asset("res/images/single-check.png", package: "money") :
                  Container(),
                ]),
